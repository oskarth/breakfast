...
{{
var G__79910 = cljs.core.pop.call(null,v__$1);
v__$1 = G__79910;
continue;
}
} else
...
{var pred__79914 = cljs.core._EQ_;var expr__79915 = limit;if(cljs.core.truth_(pred__79914.call(null,(1),expr__79915)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__79914.call(null,(2),expr__79915)))
...
var G__79917 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__79918 = (limit__$1 - (1));
var G__79919 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__79917;
limit__$1 = G__79918;
parts = G__79919;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___79921 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___79921))
{var replacement_79922 = temp__4124__auto___79921;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_79922)));
} else
{buffer.append(ch);
}
{
var G__79923 = (index + (1));
index = G__79923;
continue;
}
}
