...
{{
var G__15623 = cljs.core.pop.call(null,v__$1);
v__$1 = G__15623;
continue;
}
} else
...
{var pred__15627 = cljs.core._EQ_;var expr__15628 = limit;if(cljs.core.truth_(pred__15627.call(null,(1),expr__15628)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__15627.call(null,(2),expr__15628)))
...
var G__15630 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__15631 = (limit__$1 - (1));
var G__15632 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__15630;
limit__$1 = G__15631;
parts = G__15632;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___15634 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___15634))
{var replacement_15635 = temp__4124__auto___15634;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_15635)));
} else
{buffer.append(ch);
}
{
var G__15636 = (index + (1));
index = G__15636;
continue;
}
}
