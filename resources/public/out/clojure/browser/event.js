...
goog.require('goog.events');
clojure.browser.event.IEventType = (function (){var obj74993 = {};return obj74993;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__7981__auto__ = this$;if(and__7981__auto__)
...
{var x__8629__auto__ = (((this$ == null))?null:this$);return (function (){var or__7993__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__8629__auto__)]);if(or__7993__auto__)
{return or__7993__auto__;
} else
{var or__7993__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__7993__auto____$1)
...
return (function (p__74994){var vec__74995 = p__74994;var k = cljs.core.nth.call(null,vec__74995,(0),null);var v = cljs.core.nth.call(null,vec__74995,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__74996){var vec__74997 = p__74996;var k = cljs.core.nth.call(null,vec__74997,(0),null);var v = cljs.core.nth.call(null,vec__74997,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
} else
