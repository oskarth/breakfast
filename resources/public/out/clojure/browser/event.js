...
goog.require('goog.events');
clojure.browser.event.IEventType = (function (){var obj13899 = {};return obj13899;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__7980__auto__ = this$;if(and__7980__auto__)
...
{var x__8628__auto__ = (((this$ == null))?null:this$);return (function (){var or__7992__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__8628__auto__)]);if(or__7992__auto__)
{return or__7992__auto__;
} else
{var or__7992__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__7992__auto____$1)
...
return (function (p__13900){var vec__13901 = p__13900;var k = cljs.core.nth.call(null,vec__13901,(0),null);var v = cljs.core.nth.call(null,vec__13901,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__13902){var vec__13903 = p__13902;var k = cljs.core.nth.call(null,vec__13903,(0),null);var v = cljs.core.nth.call(null,vec__13903,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
} else
