...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_79070 = (0);while(true){
var m_79071 = cljs.core.async.impl.dispatch.tasks.pop();if((m_79071 == null))
{} else
{m_79071.call(null);
if((count_79070 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__79072 = (count_79070 + (1));
count_79070 = G__79072;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__7981__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__7981__auto__)
