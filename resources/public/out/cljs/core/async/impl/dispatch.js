...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_18363 = (0);while(true){
var m_18364 = cljs.core.async.impl.dispatch.tasks.pop();if((m_18364 == null))
{} else
{m_18364.call(null);
if((count_18363 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__18365 = (count_18363 + (1));
count_18363 = G__18365;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__7980__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__7980__auto__)
