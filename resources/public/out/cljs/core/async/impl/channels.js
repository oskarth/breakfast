...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t79076 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t79076 = (function (val,box,meta79077){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t79076.cljs$lang$type = true;
cljs.core.async.impl.channels.t79076.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t79076";
cljs.core.async.impl.channels.t79076.cljs$lang$ctorPrWriter = (function (this__8569__auto__,writer__8570__auto__,opt__8571__auto__){return cljs.core._write.call(null,writer__8570__auto__,"cljs.core.async.impl.channels/t79076");
});
cljs.core.async.impl.channels.t79076.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t79076.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_79078){var self__ = this;
var _79078__$1 = this;return self__.meta79077;
});
cljs.core.async.impl.channels.t79076.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_79078,meta79077__$1){var self__ = this;
var _79078__$1 = this;return (new cljs.core.async.impl.channels.t79076(self__.val,self__.box,meta79077__$1));
});
cljs.core.async.impl.channels.__GT_t79076 = (function __GT_t79076(val__$1,box__$1,meta79077){return (new cljs.core.async.impl.channels.t79076(val__$1,box__$1,meta79077));
});
}
return (new cljs.core.async.impl.channels.t79076(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__8572__auto__,writer__8573__auto__,opts__8574__auto__){return cljs.core._write.call(null,writer__8573__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__8569__auto__,writer__8570__auto__,opt__8571__auto__){return cljs.core._write.call(null,writer__8570__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_79079 = self__.takes.pop();if((taker_79079 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_79079))
{var take_cb_79080 = cljs.core.async.impl.protocols.commit.call(null,taker_79079);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_79080,taker_79079,this$__$1){
return (function (){return take_cb_79080.call(null,null);
});})(take_cb_79080,taker_79079,this$__$1))
);
} else
{}
{
