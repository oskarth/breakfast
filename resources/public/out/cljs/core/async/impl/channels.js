...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t18369 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t18369 = (function (val,box,meta18370){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t18369.cljs$lang$type = true;
cljs.core.async.impl.channels.t18369.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t18369";
cljs.core.async.impl.channels.t18369.cljs$lang$ctorPrWriter = (function (this__8568__auto__,writer__8569__auto__,opt__8570__auto__){return cljs.core._write.call(null,writer__8569__auto__,"cljs.core.async.impl.channels/t18369");
});
cljs.core.async.impl.channels.t18369.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t18369.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_18371){var self__ = this;
var _18371__$1 = this;return self__.meta18370;
});
cljs.core.async.impl.channels.t18369.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_18371,meta18370__$1){var self__ = this;
var _18371__$1 = this;return (new cljs.core.async.impl.channels.t18369(self__.val,self__.box,meta18370__$1));
});
cljs.core.async.impl.channels.__GT_t18369 = (function __GT_t18369(val__$1,box__$1,meta18370){return (new cljs.core.async.impl.channels.t18369(val__$1,box__$1,meta18370));
});
}
return (new cljs.core.async.impl.channels.t18369(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__8571__auto__,writer__8572__auto__,opts__8573__auto__){return cljs.core._write.call(null,writer__8572__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__8568__auto__,writer__8569__auto__,opt__8570__auto__){return cljs.core._write.call(null,writer__8569__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_18372 = self__.takes.pop();if((taker_18372 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_18372))
{var take_cb_18373 = cljs.core.async.impl.protocols.commit.call(null,taker_18372);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_18373,taker_18372,this$__$1){
return (function (){return take_cb_18373.call(null,null);
});})(take_cb_18373,taker_18372,this$__$1))
);
} else
{}
{
