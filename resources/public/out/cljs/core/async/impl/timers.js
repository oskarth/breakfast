...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__8569__auto__,writer__8570__auto__,opt__8571__auto__){return cljs.core._write.call(null,writer__8570__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_78977 = (0);while(true){
if((i_78977 < arr.length))
{(arr[i_78977] = null);
{
var G__78978 = (i_78977 + (1));
i_78977 = G__78978;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__8569__auto__,writer__8570__auto__,opt__8571__auto__){return cljs.core._write.call(null,writer__8570__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_78984 = (self__.level + (1));while(true){
if((i_78984 <= (new_level + (1))))
{(update[i_78984] = self__.header);
{
var G__78985 = (i_78984 + (1));
i_78984 = G__78985;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_78986 = (0);while(true){
if((i_78986 <= self__.level))
{var links_78987 = (update[i_78986]).forward;if(((links_78987[i_78986]) === x__$1))
{(links_78987[i_78986] = (x__$1.forward[i_78986]));
{
var G__78988 = (i_78986 + (1));
i_78986 = G__78988;
continue;
}
} else
{{
var G__78989 = (i_78986 + (1));
i_78986 = G__78989;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__7993__auto__ = (cljs.core.truth_((function (){var and__7981__auto__ = me;if(cljs.core.truth_(and__7981__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__7981__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__7993__auto__))
...
cljs.core.async.impl.dispatch.queue_delay.call(null,((function (timeout_channel,or__7993__auto__,timeout__$1,me){
return (function (){cljs.core.async.impl.timers.timeouts_map.remove(timeout__$1);
return cljs.core.async.impl.protocols.close_BANG_.call(null,timeout_channel);
});})(timeout_channel,or__7993__auto__,timeout__$1,me))
,msecs);
